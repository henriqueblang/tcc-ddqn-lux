...
def get_prediction_actions(y_A, player, opponent):
    actions = []
    ...
    for city in player.cities.values():
        for city_tile in city.citytiles:
            ...
            options = y_A[city_tile_y][city_tile_x]
...
FILE_NAME_A = "model_dqn_A_12_10.h5"
...
def agent(observation, configuration):
    ...
    if observation["step"] == 0:
        ...
        try:
            model_A.load_weights(FILE_NAME_A, by_name=True, skip_mismatch=True)
...
#         model = tf.keras.models.load_model('model.h5')
    ...
    actions, _ = get_prediction_actions(y_A, player, opponent)
